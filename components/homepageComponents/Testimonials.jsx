        ...
        <div className='flex flex-col lg:flex-row lg:h-screen bg-blueHighLight'>
            <div className='flex flex-col lg:flex-row lg:w-[80vw] mt-16 lg:m-auto '>
                ...
                <div className='lg:w-5/12 m-4 rounded-3xl overflow-hidden h-[27rem]'>
                    <img alt='sports' className='object-cover h-full '
                        src={'https://res.cloudinary.com/tacafrica/image/upload/v1663587460/my_folder/int%20youth%20day/compressed/1-2208130031_result_mvqdyj.webp'}/>
                </div>
                <div className='w-11/12 mx-auto lg:w-6/12  lg:ml-7 '>
                    ...
                    <div className='my-5'>
                        <ImQuotesRight color='#141FC3' fontSize="2.5rem"/>
                    </div>
                    <MiniSlider/>
                </div>
            </div>
