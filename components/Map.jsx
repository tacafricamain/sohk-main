...
export default function Map() {
  return (
    <div className="relative w-full map mt-28 bg-slate-100 " >
      <div className='absolute h-32  w-10/12 border border-black top-2/4 md:top-1 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
        <div className=''>

          </div>
        </div>
      <h2 className="text-3xl p-6  text-center font-mavin mb-6" >
        {/* Come Visit Us At the TAC community Hub */}
      </h2>
