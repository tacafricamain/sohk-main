      ...
      <div className="w-full  ">
        <div className="w-10/12 mx-auto space-y-6 pt-36">
          ...
          <div className="w-full aspect-video bg-gray-400 object-contain rounded-xl overflow-hidden">
              <img src="https://res.cloudinary.com/tacafrica/image/upload/v1675094183/my_folder/IBB%20golf%20tour/YOD-20230113032_fqqa2o.jpg" alt="project 774" />
          </div>
