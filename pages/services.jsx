...
export default function services() {
    return (
        <div className="w-full">
            <h1 className='text-darkBlue text-center text-3xl lg:text-7xl mb-6 pt-20  font-mavin overflow-hidden'>Our Services</h1>
                    ...
                    <Link href={
                        ...
                        <a className="space-y-4">
                            <div className="aspect-w-16 aspect-h-9 rounded-lg border-8 border-white">
                                <img className="object-cover h-[300px] lg:h-[600px] w-full shadow-md hover:shadow-xl "
                                    src={
                                        edge ?. image
                                    }
                                    alt={
