        ...
        <div className='mx-4 lg:mx-8'>
            ...
            <section className='flex flex-col lg:flex-row w-full bg-[#c3d9ff]'>
                <div className='w-full mt-10'>
                    <div className='m-5'>
                        <p className='font-semibold text-xl mb-3 mt-12 font-PanchangSemibold'>SOHK BY NUMBERS</p>
                        <h2 className='text-4xl lg:text-5xl font-semibold font-PanchangSemibold'>Numbers Of The
                            <br/>
                            First SOHK Pilot
                            <br/>
                            Program.</h2>
                    ...
                    <div className='flex  flex-col lg:flex-row w-full lg:space-x-5 mt-20'>
                        <div className='w-full m-5 lg:space-x-0'>
                            ...
                            <div className='my-5'>
                                <h3 className='text-4xl lg:text-5xl font-semibold font-PanchangSemibold'>05</h3>
                                <h4 className='font-semibold text-xl mb-3 font-PanchangSemibold'>
                        ...
                        <div className='w-full m-5'>
                            <div className='my-5'>
                                <h3 className='text-4xl lg:text-5xl font-semibold font-PanchangSemibold'>05</h3>
                                <h4 className='font-semibold text-xl mb-3 font-PanchangSemibold'>Approved Government Primary Schools</h4>
                                <ul className='font-SpaceGrotesk font-semibold opacity-90'>
                                    <li>
                            ...
                            <div className='my-5'>
                                <h3 className='text-4xl lg:text-5xl font-semibold font-PanchangSemibold'>05</h3>
                                <h4 className='font-semibold text-xl mb-3 font-PanchangSemibold'>Approved Senior Secondary Schools</h4>
                                <ul className='font-SpaceGrotesk font-semibold opacity-90'>
                                    <li>
                                        - GSS Bwari</li>
                                    <li>
